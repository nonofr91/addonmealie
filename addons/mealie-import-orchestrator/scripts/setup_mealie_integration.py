...
ADDON_UI_URL = os.environ.get("ADDON_UI_URL", "http://localhost:8501")

# Configuration
COOKBOOK_NAME = "📥 Import Orchestrator"
COOKBOOK_DESCRIPTION = "Importateur de recettes depuis le web et audit de qualité"
COOKBOOK_SLUG = "import-orchestrator"

RECIPE_NAME = "📥 Import Orchestrator"
RECIPE_DESCRIPTION = f"""
Importateur de recettes depuis le web et audit de qualité.

Cette recette spéciale fournit un lien vers l'interface d'import
de l'addon mealie-import-orchestrator.

**[Ouvrir Import Orchestrator →]({ADDON_UI_URL})**

Fonctionnalités :
- Import de recettes depuis n'importe quel site web (Marmiton, 750g, etc.)
- Audit de la qualité des recettes importées
- Enrichissement nutritionnel automatique
- Gestion des ingrédients et des images
"""
TAG_NAME = "import-addon"
...
def create_import_orchestrator_recipe(tag_id: str) -> dict:
    """Crée la recette spéciale Import Orchestrator via mcp_auth_wrapper."""
    import requests
...
def main():
    """Fonction principale."""
    print("=" * 60)
    print("Configuration de l'intégration Mealie pour Import Orchestrator")
    print("=" * 60)
    ...
    try:
        ...
        recipe = create_import_orchestrator_recipe(tag_id)
        print()
