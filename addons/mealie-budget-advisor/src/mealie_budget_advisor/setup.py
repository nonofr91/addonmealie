"""Setup script for automatic Budget Advisor fake recipe in Mealie."""
...
class MealieSetup:
    """Creates the Budget Advisor placeholder recipe + Addon cookbook."""
    ...
    def _create_fake_recipe(self) -> str:
        ...
        recipe_name = "\U0001f4b0 Budget Advisor"

        description = "Acc\u00e8s \u00e0 l'interface de l'addon Budget.\n\n"
        if ui_url:
        ...
        requests.patch(
            ...
            json={
                ...
                "orgURL": ui_url,
                "tags": [{"name": ADDON_TAG_NAME}, {"name": "budget"}],
            },
            timeout=10,
        ).raise_for_status()
